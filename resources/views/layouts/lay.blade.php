...
<head>
    ...
    <title>Tickets Prueba Luis Jimenez</title>
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Luis Jimenez <span class="caret"></span></a>
